...
export default function TransferPreferencesForm({
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-card rounded-xl border border-border shadow-sm overflow-hidden">
            <div
                className="p-6 border-b border-border cursor-pointer hover:bg-muted/30 transition-colors flex items-center justify-between"
            ...
            {isExpanded && (
                <>
                    ...
                    <div className="px-6 py-4 bg-muted/30 border-t border-border flex justify-end animate-in slide-in-from-top-2 duration-200">
                        <button
                            type="submit"
                            disabled={isSaving}
